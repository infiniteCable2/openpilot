...
def main(demo=False):
  ...
  while True:
    ...
    # transport is always valid if torqued is running; curvature_live_valid indicates data quality
    curvature_transport_valid = True
    ...
    # both at 4Hz driven by livePose
    if sm.frame % 5 == 0:
