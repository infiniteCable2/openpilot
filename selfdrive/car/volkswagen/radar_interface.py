...
class RadarInterface(RadarInterfaceBase):
  ...
  def _update(self, updated_messages):
    ...
    if valid:
      ...
      self.pts[signal_part].dRel     = max(0, msg['Same_Lane_01_Long_Distance'] - msg['Same_Lane_01_Offset']) # negative values possible
    ...
    if valid:
      self.pts[signal_part].measured = True
      self.pts[signal_part].dRel     = max(0, msg['Same_Lane_02_Long_Distance'] - msg['Same_Lane_02_Offset'])
