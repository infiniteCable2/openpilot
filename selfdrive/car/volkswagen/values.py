...
class CarControllerParams:
  ...
  def __init__(self, CP):
    ...
    if CP.flags & VolkswagenFlags.PQ:
      ...
      self.ANGLE_RATE_LIMIT_UP             = AngleRateLimit(speed_bp=[0., 5., 10., 15.], angle_v=[12., 10., 4., 0.6])
      self.ANGLE_RATE_LIMIT_DOWN           = AngleRateLimit(speed_bp=[0., 5., 10., 15.], angle_v=[12., 11., 6., 0.8])
